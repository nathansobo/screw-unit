module Sprockets
  class Preprocessor
    attr_reader :environment, :concatenation, :source_files, :dependency_ordered_source_files, :asset_paths
    
    def initialize(environment, options = {})
      @environment = environment
      @concatenation = Concatenation.new
      @source_files = []
      @dependency_ordered_source_files = []
      @asset_paths = []
      @options = options
    end
    ...
    def require(source_file)
      ...
      dependency_ordered_source_files.push(source_file)
    end
