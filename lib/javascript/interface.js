  ...
  module("Interface", function() {
    ...
    def('ProgressBar', {
      ...
      methods: {
        after_initialize: function() {
          var self = this;
          var total_examples = this.runnable.total_examples();
          var completed_examples = 0;
          var progress = self.find('div#screw_unit_progress');
          progress.css("width", "0%");
          this.runnable.on_example_completed(function(example) {
            completed_examples++;
            progress.css("width", (completed_examples / total_examples * 100).toString() + "%");
          });
        }
      }
    });
